...
md_file = '../B2B/labeldata1.csv'
md_df = pd.read_csv(md_file)  #, header=0, index_col=False, keep_default_na=True
# print(md_df)
X = md_df.drop(['Test Case id','label'], axis=1)  #.drop(['Label','Test Case ID','Functionality Module','Test Case Description','Severity','Priority'], axis=1)  #'Test Case ID','Functionality Module','Test Case Description','Severity	Priority'
